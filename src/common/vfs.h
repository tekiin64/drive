...
public:
     ...
     * folderPath is relative to the sync folder. Can be "" for root folder.
     */
    Q_REQUIRED_RESULT virtual AvailabilityResult availability(const QString &folderPath, AvailabilityRecursivity recursiveCheck) = 0;
...
public:
    ...
    AvailabilityResult availability(const QString &, AvailabilityRecursivity) override { return VfsItemAvailability::AlwaysLocal; }
